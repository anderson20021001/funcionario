...
$page_nav['cadastro']['sub'] += array("cadastro" => array("title" => "Funcionário", "url" => APP_URL . "/filtroFuncionario.php"));


//TABELA BASICA
$page_nav['tabelaBasica'] = array("title" => "Tabela Básica", "icon" => " fa-pencil-square-o");
$page_nav['tabelaBasica']['sub'] = array();
